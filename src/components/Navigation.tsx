      ...
      <nav className="bg-gray-900 text-white shadow-xl fixed top-0 w-full z-50 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            {/* Logo */}
            <div className="flex items-center space-x-3 cursor-pointer group flex-1 min-w-0" onClick={() => onNavigate('home')}>
              ...
              <div className="block min-w-0">
                <h1 className="text-lg sm:text-2xl font-bold text-white sm:bg-gradient-to-r sm:from-indigo-500 sm:to-purple-600 sm:bg-clip-text sm:text-transparent leading-tight">
                  Udaan - The Endless Journey
                </h1>
                <p className="text-[11px] sm:text-xs text-gray-300 sm:text-gray-400 font-medium leading-tight">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              {navItems.map(item => (
                <button
                  ...
                  className={`relative font-semibold px-4 py-2 transition-all duration-300 group overflow-hidden rounded-lg ${currentPage === item.id ? 'text-white bg-gradient-to-r from-indigo-600 to-purple-600 shadow-lg' : 'text-gray-300 hover:text-white'}`}
                >
              ...
              <img
                ...
                alt="University logo"
                className="h-9 w-16 rounded-md object-contain bg-transparent shadow-lg"
              />
            </div>
